...
import { FaBook, FaChalkboardTeacher, FaCalendarAlt, FaClock, FaLink, FaUsers, FaDollarSign, FaSave } from "react-icons/fa";
      ...
      <div className="flex min-h-screen bg-gray-50">
        ...
        <main className="flex-1 flex justify-center items-center py-3 px-0 sm:px-2">
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="text-blue-500 font-semibold text-lg">Cargando curso...</div>
          </div>
        </main>
      </div>
    );
          ...
          <div className="mb-8 bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-6 text-white shadow-lg">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-blue-100 mt-2">Actualiza la información del curso existente</p>
              </div>
