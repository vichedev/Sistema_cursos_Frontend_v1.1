...
export default function ModalEliminarUsuario({ user, onClose, onDelete, loading, error }) {
  ...
  return (
    <Modal onClose={onClose}>
      ...
      {/* Error message */}
      {error && (
        <div className="mb-6 p-4 bg-red-50 text-red-700 rounded-xl border border-red-200 flex items-start gap-2">
      ...
      <div className="bg-red-50 border border-red-200 rounded-xl p-6 mb-6 shadow-sm">
        <p className="text-red-800 text-center text-lg font-semibold">
