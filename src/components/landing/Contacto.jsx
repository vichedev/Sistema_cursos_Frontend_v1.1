      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ¿Tienes alguna duda o necesitas ayuda? Nuestro equipo de soporte
            está listo para asistirte. Completa el formulario o usa los medios
            directos para contactarnos.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mb-16">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-purple-200 group">
              ...
              <p className="text-center text-purple-600 mt-3 font-semibold">
                ✨Grupo Maat✨
              </p>
            </div>
          </div>
            ...
            <form ref={form} onSubmit={sendEmail} className="space-y-8">
              ...
              <div className="mt-8 p-6 bg-blue-50 rounded-xl border-2 border-blue-100">
                ...
                <ol className="list-decimal list-inside space-y-2 text-blue-800">
                  <li className="ml-4">
                    Recibirás un correo de confirmación automático.
                  </li>
                  <li className="ml-4">
                    Nuestro equipo revisará tu solicitud en menos de 24 horas.
                  </li>
                  <li className="ml-4">
                    Te contactaremos por el medio que nos hayas indicado.
                  </li>
                </ol>
                <p className="mt-4 text-sm text-blue-700 font-medium">
                  Todos tus datos están protegidos bajo nuestra política de
                  privacidad.
                </p>
              </div>
            </form>
